...
public class OrdenController {
     ...
     *
     * @param realizarOrdenPort Puerto para realizar operaciones de orden.
     */
    public OrdenController(RealizarOrdenPort realizarOrdenPort) {
        this.realizarOrdenPort = realizarOrdenPort;
    }
    ...
    public ResponseEntity<OrdenResponse> realizarOrden(
            @RequestBody RealizarOrdenRequest request,
    ...
    private String extraerEmailDelToken(String token) {
